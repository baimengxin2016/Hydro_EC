...
load('./data/recsample_new/recsample72.mat');recsample(2,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample73.mat');recsample(3,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample74.mat');recsample(4,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample75.mat');recsample(5,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample76.mat');recsample(6,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample77.mat');recsample(7,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample78.mat');recsample(8,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample79.mat');recsample(9,1)=struct('sample',sample);clear sample
...
% load('G:\IGSNRR\中国东部数据集重建\code\旱涝等级\重建\fourth_supplement_treering_in_misslocation\data\speleothems_row7.mat')
% tree(7,9).tree=cat(2,tree(7,9).tree,row79);
...
save('./data/sub_spe/zheng_subchina_row7_R2p.mat','subchina','subR2','recRECE','submiss','R2max');
