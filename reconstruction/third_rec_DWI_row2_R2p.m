...
load('./data/recsample_new/recsample22.mat');recsample(2,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample23.mat');recsample(3,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample24.mat');recsample(4,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample25.mat');recsample(5,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample26.mat');recsample(6,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample27.mat');recsample(7,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample28.mat');recsample(8,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample29.mat');recsample(9,1)=struct('sample',sample);clear sample
...
% load('G:\IGSNRR\中国东部数据集重建\code\旱涝等级\重建\fourth_supplement_treering_in_misslocation\data\tree_row2.mat')
% tree(2,4).tree=cat(2,tree(2,4).tree,row24);
% load('G:\IGSNRR\中国东部数据集重建\code\旱涝等级\重建\fourth_supplement_treering_in_misslocation\data\speleothems_row2.mat')
% tree(2,8).tree=cat(2,tree(2,8).tree,row28);
...
save('./data/sub_spe/zheng_subchina_row2_R2p.mat','subchina','subR2','recRECE','submiss','R2max');
