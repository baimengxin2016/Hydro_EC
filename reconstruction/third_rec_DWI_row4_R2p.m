...
load('./data/recsample_new/recsample42.mat');recsample(2,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample43.mat');recsample(3,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample44.mat');recsample(4,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample45.mat');recsample(5,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample46.mat');recsample(6,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample47.mat');recsample(7,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample48.mat');recsample(8,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample49.mat');recsample(9,1)=struct('sample',sample);clear sample
...
% load('G:\IGSNRR\中国东部数据集重建\code\旱涝等级\重建\fourth_supplement_treering_in_misslocation\data\tree_row4.mat')
% tree(4,8).tree=cat(2,tree(4,8).tree,row48);
% load('G:\IGSNRR\中国东部数据集重建\code\旱涝等级\重建\fourth_supplement_treering_in_misslocation\data\speleothems_row4.mat')
% tree(4,8).tree=cat(2,tree(4,8).tree,row48);
...
save('./data/sub_spe/zheng_subchina_row4_R2p.mat','subchina','subR2','recRECE','submiss','R2max');
