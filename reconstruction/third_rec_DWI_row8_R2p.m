...
recsample(2,1)=struct('sample',[]);
load('./data/recsample_new/recsample83.mat');recsample(3,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample84.mat');recsample(4,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample85.mat');recsample(5,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample86.mat');recsample(6,1)=struct('sample',sample);clear sample
recsample(7,1)=struct('sample',[]);
load('./data/recsample_new/recsample88.mat');recsample(8,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample89.mat');recsample(9,1)=struct('sample',sample);clear sample
...
load('G:\IGSNRR\中国东部数据集重建\code\旱涝等级\重建\fourth_supplement_treering_in_misslocation\data\tree_row8.mat')
tree(8,5).tree=cat(2,tree(8,5).tree,row85);
...
save('./data/sub_spe/zheng_subchina_row8_R2p.mat','subchina','subR2','recRECE','submiss','R2max');
