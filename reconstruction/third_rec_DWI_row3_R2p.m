...
% load('./data/recsample_new/recsample31.mat');recsample(1,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample32.mat');recsample(2,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample33.mat');recsample(3,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample34.mat');recsample(4,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample35.mat');recsample(5,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample36.mat');recsample(6,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample37.mat');recsample(7,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample38.mat');recsample(8,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample39.mat');recsample(9,1)=struct('sample',sample);clear sample
...
save('./data/sub_spe/zheng_subchina_row3_R2p.mat','subchina','subR2','recRECE','submiss','R2max');
