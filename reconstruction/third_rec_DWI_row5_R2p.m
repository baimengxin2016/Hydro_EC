...
load('./data/recsample_new/recsample52.mat');recsample(2,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample53.mat');recsample(3,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample54.mat');recsample(4,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample55.mat');recsample(5,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample56.mat');recsample(6,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample57.mat');recsample(7,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample58.mat');recsample(8,1)=struct('sample',sample);clear sample
load('./data/recsample_new/recsample59.mat');recsample(9,1)=struct('sample',sample);clear sample
...
load('../fourth_supplement_treering_in_misslocation/data/tree_row5.mat')
tree(5,4).tree=cat(2,tree(5,4).tree,row54);
...
save('./data/sub_spe/zheng_subchina_row5_R2p.mat','subchina','subR2','recRECE','submiss','R2max');
